...
9. Pregunta al usuario qué hacer con los archivos originales después de procesarlos (1: Eliminarlos, 2: Moverlos a un directorio "OLD", 3: Mantenerlos en su sitio. Por defecto: Moverlos al directorio).
"""
