#!/usr/bin/env python3
"""
Compresor Fotográfico v3.2 - Igual que la v3.0 pero corrige el problema de conversión
PNG -> JPG/JPEG manejando imágenes con canal alfa.
"""

# Copia de la v3.0 con el fix aplicado
import os
import sys
import shutil
import subprocess
...
def process_single_image(args):
    ...
    try:
        ...
        if ext_for_format == 'TIFF':
            ...
            # FIX: convertir a RGB si tiene canal alfa
